<?php  defined('C5_EXECUTE') or die('Access Denied');
	...
	<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Schedule Content'), t('Schedule content on your site.'), false, false);?>
...
<div class="ccm-pane-body">	
	...
	<table id="add_event" class="table">

		<tr>
			<td width="50%">
				<strong><?php   echo $form->label('contentTitle', t('Content Title'))?></strong>
			</td>
            <td >
				<strong><?php   echo $form->label('contentCategory', t('Category'))?></strong>
			</td>
		</tr>
		<tr>
			<td >
		...
		<tr>
			<td colspan="2">
				<strong><?php   echo $form->label('publishDate', t('Publish Date/Time'))?></strong>
			</td>
		...
		<tr>
			<td>
				...
				<strong><?php   echo $form->label('contentImage', t('Image'))?></strong>
			</td>
			<td>
				<strong><?php   echo $form->label('imageCaption', t('Image Caption'))?></strong>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<strong><?php   echo $form->label('moreLink', t('Read More Link'))?></strong>
			</td>
			<td>
				<strong><?php   echo $form->label('linkText', t('Link Text'))?></strong>
			</td>
		</tr>
        <tr>
			<td>
        ...
        <tr>
			<td colspan="2">
				<strong><?php   echo $form->label('contentText', t('Content Text'))?></strong>
			</td>
